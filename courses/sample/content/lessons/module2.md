...
Exercises live in JSON files under `content/exercises/`. Each file is named `moduleN-variants.json` and contains warmups and challenges with multiple variants per exercise.
...
```json
{
  ...
  "concept": "Variables",
  "variants": [
    { "id": "v1", "title": "Declare an integer", "description": "..." },
    { "id": "v2", "title": "Declare a string", "description": "..." },
    { "id": "v3", "title": "Declare a boolean", "description": "..." }
  ]
}
```
        ...
        "variants": [
          {
            ...
            "annotations": [
              { "type": "tip", "label": "Label", "text": "Explanation." }
            ]
          }
        ]
      }
...
- Exercises are **JSON files** with warmups and challenges

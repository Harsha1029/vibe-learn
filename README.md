...
- **Analytics dashboard** — weak concept report, module strength rankings (including algorithm categories), per-concept strength breakdown, top 10 weakest exercises, rating breakdowns. Algorithm SRS data is integrated alongside module data

...
// Inline script that runs before CSS paints to prevent theme flash.
// Reads the saved theme from localStorage and sets data-theme on <html>
// immediately, so the correct theme CSS selectors match on first render.
const themeInitScript = `    <script>(function(){try{var t=localStorage.getItem('vibe-learn-theme')||'factorio-dark';if(t&&t!=='dark')document.documentElement.setAttribute('data-theme',t)}catch(e){}})()</script>`;
